...
export default function App() {
                ...
                <td>
                  ...
                  <button
                    onClick={() => {
                      if (
                        window.confirm(
                          `Are sure you want to delete the post titled "${post.title}"`
                        )
                      )
  ...
  function onPostCreated(createdPost) {
    ...
    alert(
      `Post successfuly created. After clicking OK, your new post tilted "${createdPost.title}" will show up in the table below.`
    );
    getPosts();
  }
